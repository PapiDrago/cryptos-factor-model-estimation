...
\begin{frame}{Results: Factor Model vs. AR Benchmark}
    ...
    \begin{itemize}
        ...
        \item \textbf{Interpretation:} For the majority of the sample, the best predictor is simply the \textbf{historical sample mean}.    \end{itemize}
\end{frame}
...
\begin{frame}{Robustness Check: Expanding the Cross-Section ($N$)}
    ...
    \begin{block}{The Fundamental Question}
        Does a factor structure actually exist in the data (i.e., is $k > 0$)? 
    \end{block}
    \end{frame}
% conclusioni
